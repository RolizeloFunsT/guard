...
client.channels.get(796056039359250443).send(`:inbox_tray: | <@${member.id}> adlı kişi sunucuya giriş yaptı. `)
if(member.user.bot === true) {
  client.channels.get(796056039359250443).send("Bu kişi bir bot olarak giriş yaptı.")
} 
} else {
	return;
}
